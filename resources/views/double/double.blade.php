  ...
  <div class="row">
    <div class="col-sm-12">
        <table class="table">
          ...
          <h4>Chose your double room</h4><br>  
          <tbody>
            <tr>
              <th scope="row">Double Room</th>
              <td>
                <form action="{{ route('store.double_room') }}" method="POST">  
                    @csrf  
                    ...
                    <label for="Category"><strong>Select your suitable double room: </strong></label><br>
   ...
   <h1 class="text-center mb-5">Some Double room sample</h1>
  <div class="row">
    <div class="col-sm-4">
